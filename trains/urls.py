...
urlpatterns = [
    ...
    # path('add/', TrainCreateView.as_view(), name='city_add'),
    # path('update/<int:pk>/', TrainUpdateView.as_view(), name='city_udpate'),
    # path('delete/<int:pk>/', TrainDeleteView.as_view(), name='city_delete'),
